...
UBUNTU_TRANSLATION_DOMAIN="animation.larreamikel"
...
aptest.commands = bash $$PWD/Animation/tests/autopilot/run
aptest.depends  = sub-Animation

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/Animation/tests/unit 
unittest.depends  = sub-Animation
